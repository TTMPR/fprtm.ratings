...
--              o todos a la vez (Supabase los procesa en orden)
-- ============================================================

-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: 1600 Under                                           ║
-- ║  47 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(39831,66057),(19099,27146),(93136,53025),(37607,99065),(86099,81200),(13248,65610),(97806,26683),(62743,66057),(27146,91678),(97900,93136),
(37607,15817),(81200,78146),(61876,34914),(48752,19099),(48752,30866),(19099,61876),(30866,34914),(48752,37607),(19099,39831),(61876,36158),
(34914,86099),(30866,65610),(48752,62743),(37607,78146),(39831,97900),(19099,97806),(36158,13248),(61876,81200),(78146,27146),(39831,99065),
(97806,53025),(36158,26683),(34914,93136),(65610,66057),(30866,39154),(48752,91678),(81200,15817);
...
-- ── 4. Calcular puntos e insertar partidos ────────────────────
    ...
    LOOP
        IF NOT r.w_found OR NOT r.l_found THEN
            RAISE NOTICE 'ID no encontrado — winner: % (found: %), loser: % (found: %)',
    ...
    RAISE NOTICE 'Partidos guardados: %,  omitidos: %', v_saved, v_skipped;

-- ── 5. Actualizar New Rating ──────────────────────────────────
...
-- ── 6. Snapshot resultados_evento ─────────────────────────────
    ...
    RAISE NOTICE 'Snapshots: %', (SELECT COUNT(*) FROM _deltas WHERE wins+losses > 0);
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: 1900 Under                                           ║
-- ║  44 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(14207,89840),(99593,18675),(51347,56566),(58520,51245),(45382,76540),(88172,31417),(32431,30969),(89840,16175),(99593,28726),(37869,56566),
(95909,58520),(39871,84341),(14207,39871),(14207,51347),(39871,32431),(14207,56566),(51347,40021),(32431,89840),(39871,45382),(56566,95909),
(14207,83000),(40021,99593),(51347,16175),(32431,28726),(89840,17331),(45382,88172),(39871,51245),(16175,37869),(28726,30969),(89840,18675),
(56566,58520),(83000,76540),(40021,31417),(51245,84341);
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: Abierto - OPEN                                       ║
-- ║  15 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(24592,54597),(28289,93810),(24592,37869),(54597,95181),(28289,57400);
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: 1800 Under                                           ║
-- ║  62 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(66985,82512),(60432,69470),(88172,75612),(65333,76542),(33416,30969),(91959,24371),(92240,49117),(16175,79514),(25014,99353),(76540,74686),
(82512,86503),(60432,98259),(88172,97684),(65333,19287),(69177,30969),(24371,87128),(92240,57576),(16175,72296),(65444,25014),(74686,21226),
(57447,52487),(92240,33416),(33416,65333),(92240,57447),(65333,76540),(33416,16175),(92240,74686),(57447,60432),(76540,24371),(65333,21226),
(33416,25014),(16175,69470),(92240,79514),(74686,91959),(60432,49117),(57447,76542),(69470,57576),(16175,98259),(92240,97684),(79514,66985),
(74686,65444),(91959,30969),(49117,88172),(60432,72296),(76540,86503),(24371,75612),(21226,82512),(65333,87128),(33416,19287),(25014,52487),
(76542,69177),(57447,99353);
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: 1700 Under                                           ║
-- ║  80 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(85525,43386),(48890,11934),(59672,85914),(71953,40161),(41850,42493),(34957,25860),(95180,96374),(50857,98259),(17944,65461),(35112,72296),
(96474,40982),(19287,18834),(40007,41195),(27342,87128),(38864,85525),(73699,11934),(57576,59672),(40161,34914),(40007,97062),(87128,15817),
(38864,43386),(73699,48890),(42493,76768),(19099,25860),(95180,57795),(50857,27154),(65461,41285),(72296,86503),(96474,38534),(57576,85914),
(57795,11934),(25860,85914),(86503,17944),(65461,95180),(95180,50857),(35112,40982),(95180,73699),(50857,19287),(65461,35112),(40982,18834),
(73699,41195),(95180,71953),(50857,19099),(19287,96474),(35112,40161),(65461,96374),(40982,98259),(18834,57576),(19287,42493),(96474,57795),
(35112,25860),(40161,40007),(96374,27342),(65461,48890),(40982,34957),(98259,41850),(73699,27154),(41195,87128),(71953,41285),(95180,43386),
(50857,59672),(19099,38864),(18834,85525),(57576,86503),(48890,76768),(40982,15817),(98259,97062),(27154,38534),(43386,72296),(59672,34914);
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: 1500 Under                                           ║
-- ║  38 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(63264,43130),(97153,36306),(42772,32810),(39007,92264),(69929,60523),(63279,63264),(27578,97153),(74515,49240),(63279,69929),(63279,27578),
(69929,74515),(27578,42772),(63279,92264),(69929,39007),(74515,79983),(27578,49240),(42772,84593),(92264,33583),(63279,60523),(69929,63264),
(39007,90854),(79983,90676),(74515,36306),(60523,21847),(63264,81020),(49240,43130),(42772,32810),(36306,97153);
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: 13U - Femenino                                       ║
-- ║  17 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(80678,69929),(97900,82512),(80678,78146),(69929,32810),(97900,38016),(82512,84593),(84593,63264);
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: 13U - Masculino                                      ║
-- ║  27 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(50857,27578),(57576,42772),(79514,90676),(60432,48752),(92240,63354),(92240,79514),(79514,60432),(92240,57576),(60432,63354),(79514,50857),
(57576,95180),(92240,48752),(63354,15075),(50857,90676),(79514,42772),(95180,27578),(48752,13617);
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: Sub21 - Abierto                                      ║
-- ║  11 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: Seniors - 40+                                        ║
-- ║  8 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(53404,44795),(25860,77391),(19305,94080),(10074,53404),(25860,92264),(19305,65108),(10074,44795);
...
-- ╔══════════════════════════════════════════════════════════════╗
-- ║  EVENTO: 15U - Femenino                                       ║
-- ║  26 partidos — Albergue Olímpico 2026                      ║
-- ╚══════════════════════════════════════════════════════════════╝
DO $$
DECLARE
    v_torneo_id     INTEGER;
...
(14207,49321),(74686,98259),(71953,93748),(16175,49321),(49117,86503),(93748,98259),(71953,87128),(74686,16175),(14207,49117),(84341,93748),
(19358,87128),(74686,49321),(14207,86503),(84341,98259),(19358,71953),(45382,40007);
