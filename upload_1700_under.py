#!/usr/bin/env python3
"""
Script para cargar los resultados del torneo 1700 Under (Albergue Olímpico 2026)
...
Uso: python3 upload_1700_under.py

Notas:
  - Omite partidos donde winner o loser no tienen fprtm|ID
  - Omite walkovers puros (todos los scores son 0)
  - Los scores 7,7,7 se procesan como partidos reales
"""
