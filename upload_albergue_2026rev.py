#!/usr/bin/env python3
"""
Script para cargar los resultados del torneo Albergue Olímpico 2026 Rev
...
Uso: python3 upload_albergue_2026rev.py
...
CSV_FILE      = 'albergue.olimpico.2026rev'

TORNEO_NOMBRE = 'Albergue Olímpico 2026 Rev'
