...
--
-- Depende de: 010 ("Base de Datos"), 030 (insc_registro), 040 (app_settings).
--
-- Origen: sql/create_insc_equipos.sql + sql/create_busca_companero.sql,
-- copiados literalmente del estado ACTUAL de main. Los módulos originales ya
-- son idempotentes, autocontenidos y ordenados; reescribirlos introduciría
-- deriva respecto a producción.
--
-- ⚠️  COPA OLÍMPICA 2026 ESTÁ EN CURSO. Este fichero debe reproducir el
--     comportamiento vigente en main, no una versión anterior ni una mejora.
--     Resincronizado el 2026-09-08 tras detectar que la copia anterior
--     conservaba el comportamiento retirado en el que insc_equipos_liberar()
--     expiraba sola las reservas sin pagar.
--
--     Comportamiento vigente:
--       · una reserva vencida sin pagar NO se expira sola y conserva su cupo
--       · insc_equipos_liberar() sólo cuenta las vencidas (vencidas_sin_pago)
--         y promueve la lista de espera a los cupos realmente libres
--       · cancelar una inscripción es una decisión de la federación
--       · editar_equipo() permite corregir nombres y jugadores de un equipo
--
--     Cualquier cambio aquí debe venir de main, nunca al revés.
-- ============================================================================
